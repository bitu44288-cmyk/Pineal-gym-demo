          ...
          <div className="space-y-24">
            <section>
              ...
              <p className="text-xl md:text-2xl text-gray-300 leading-relaxed font-light">
                Elite Fitness Gym was born in the chaos of Rourkela, a beacon for those seeking clarity through physical exertion. We rejected the neon-lit, sterile corporate gym aesthetic for something raw, primal, and focused.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-400 leading-relaxed">
                We are not for everyone. We are for the obsessed. The early risers. The late grinders. When you step into Elite Fitness, you leave your ego at the door, but bring your ambition.
              </p>
            </section>
          </div>
        </div>
