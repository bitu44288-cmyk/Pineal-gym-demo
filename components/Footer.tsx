      ...
      <div className="max-w-[1400px] mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          <div className="md:col-span-5">
            ...
            <div className="flex gap-4">
              ...
              <button className="btn-premium bg-pineal text-black px-6 py-3 font-bold uppercase text-xs tracking-widest hover:bg-white">Subscribe</button>
            </div>
          </div>
        ...
        <div className="w-full h-64 md:h-80 mb-12 grayscale hover:grayscale-0 transition-all duration-500 border border-white/10 relative group">
          ...
          <a 
            ...
            className="btn-premium absolute bottom-4 right-4 bg-pineal text-black px-6 py-3 font-bold uppercase text-xs tracking-widest hover:bg-white shadow-lg z-10 flex items-center gap-2"
          >
