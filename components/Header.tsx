    ...
    <>
        ...
        <div className="max-w-[1400px] mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            <a 
              ...
              className="hidden md:flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-white hover:text-pineal transition-colors"
            >
              <span>Join Now</span>
      ...
      <div className={`fixed inset-0 z-40 bg-dark-900 transition-transform duration-500 ease-in-out ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'} md:hidden flex flex-col justify-center items-center`}>
        <div className="flex flex-col gap-8 text-center">
          ...
          <a 
            href={`tel:${GYM_DETAILS.phone}`} 
            className="mt-8 px-8 py-3 bg-pineal text-black font-bold uppercase tracking-wider rounded-none hover:bg-white transition-colors"
          >
            Start Membership
          </a>
        </div>
